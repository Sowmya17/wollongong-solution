...
<body style="background-image:url(images/waitbg4.jpg); background-repeat:no-repeat;" onload="startTime()">
...
<asp:UpdatePanel ID="UpdatePanel7" runat="server">
        <ContentTemplate>
<asp:Label ID="lbl_br" runat="server" ForeColor="#00FF00" Text="MAC" Visible="false" Font-Size="25pt"></asp:Label>
</ContentTemplate>
        </asp:UpdatePanel>
</td>
</tr>
...
<table class="rotate_right2" style="margin-top:780px; margin-left:-380px;" cellspacing="10" >
...
<asp:UpdatePanel ID="UpdatePanel24" runat="server" >
        <ContentTemplate>
<asp:Label ID="lbl_poda" runat="server" ForeColor="Lime" Text="HITH" Visible="false" Font-Size="15pt" 
...
<asp:UpdatePanel ID="UpdatePanel25" runat="server" >
        <ContentTemplate>
<asp:Label ID="lbl_a5" runat="server" ForeColor="#00FF00" Text="A5" Visible="false" Font-Size="25pt"></asp:Label>
</ContentTemplate>
        </asp:UpdatePanel>
</td>
...
<asp:UpdatePanel ID="UpdatePanel26" runat="server">
        <ContentTemplate>
<asp:Label ID="lbl_a6" runat="server" ForeColor="#00FF00" Text="A6" Visible="false" Font-Size="25pt"></asp:Label>
</ContentTemplate>
        </asp:UpdatePanel>
</td>
...
<asp:UpdatePanel ID="UpdatePanel27" runat="server" >
        <ContentTemplate>
<asp:Label ID="lbl_pat" runat="server" ForeColor="#00FF00" Text="PAT" Visible="false" Font-Size="25pt"></asp:Label>
</ContentTemplate>
        </asp:UpdatePanel>
</td>
...
<asp:UpdatePanel ID="UpdatePanel28" runat="server" >
        <ContentTemplate>
<asp:Label ID="lbl_r4" runat="server" ForeColor="#00FF00" Text="R4" Visible="false" Font-Size="25pt"></asp:Label>
</ContentTemplate>
        </asp:UpdatePanel>
</td>
