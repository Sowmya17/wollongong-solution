<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kiosksuccessnew.aspx.cs" Inherits="kiosksuccessnew" %>
  ...
  <table style="margin-top:200px; margin-left:300px; " 
       ...
       <table style="margin-top:70px; margin-left:70px;" 
        align="center">
                <tr>
                <td>
                &nbsp;<asp:Label ID="Label1" runat="server" Text="Please contact registration counter for further assistance ." Font-Bold="True" ForeColor="Brown"
