<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HITHPrint.aspx.cs" Inherits="reynolds" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;<asp:Label ID="Label10" runat="server" CssClass="style4" Height="33px" 
        ...
        <br />
        <asp:Label ID="Label3" runat="server" CssClass="style4" Height="33px" 
        Text="Queue Number" Width="151px" Font-Size="18pt"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Q_Number" runat="server" CssClass="style5" Font-Size="40pt" 
        Height="49px" Text="DE12-234" Width="235px"></asp:Label>
    &nbsp;&nbsp;<br />
    <br />
    <%--<asp:Label ID="Label1" runat="server" CssClass="style2" Height="26px" 
        Text="Unique CMI No" Width="144px" Font-Bold="True" Font-Size="X-Large"></asp:Label>--%>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%--<asp:Label 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;<br />
    <asp:Label ID="Label2" runat="server" CssClass="style2" Height="26px" 
        Width="165px" Font-Bold="False" Font-Size="X-Large" 
        Text="Selected Service"></asp:Label>
    ...
    <asp:Label ID="Date_Time" runat="server" 
        ...
        Text="Dept Name" Width="457px" Font-Bold="True" Font-Size="X-Large"></asp:Label>
        <br />
    ...
    <asp:Label ID="Label4" runat="server" CssClass="style2" Height="26px" 
        ...
        Text="Date & Time" Width="458px" Font-Bold="False" Font-Size="X-Large"></asp:Label>
    <br />
    ...
    <asp:Label ID="Label7" runat="server" CssClass="style2" Height="26px" 
        Text="THANK YOU, PLEASE WAIT FOR YOUR TURN" Width="542px" Font-Bold="True" 
