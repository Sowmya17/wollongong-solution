<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kioskhindiprintchecking.aspx.cs" Inherits="kioskerror" %>
...
<head id="Head1" runat="server">
   ...
   <meta http-equiv="refresh" content="3;url=../kiosklang.aspx"/>
                ...
                <tr>
                   ...
                   <tr>
                    <td colspan="2" align="center" valign="middle">
                       <%-- <asp:Label ID="Label1" runat="server" Text="Your ESIC No Not Registered,Please Processed in Customer Request Terminal" 
                            Font-Bold="True" Font-Size="XX-Large"></asp:Label>--%>
                            <%-- <img alt="" src="../images/hindi/21.png" height="100" width="800" />
                              <img alt="" src="../images/hindi/22.png" height="100" width="800" />--%>
