...
public partial class kiosksuccessnew : System.Web.UI.Page
{
    ...
    string dept
    {
        ...
        get { return ViewState["dept"] as string; }
   ...
   public string queno
    ...
    
    {
        ...
        if (!IsPostBack)
        {
            ...
            dept = Server.UrlDecode(Request.QueryString["1"]);
            queueno1 = Server.UrlDecode(Request.QueryString["2"]);
            ...
            {
                Label1.Text = "Please contact registration counter for further assistance .";
    ...
    public void printappointment()
    {
                        ...
                        if (dtbl.Rows.Count > 0)
                        {
                            foreach (DataRow dr in dtbl.Rows)
                            {
                               ...
                               // updatesuccess = kioskcntrl.UpdateDeptQueuNo(selectedItem1, showqueueno);
                                ...
                                string apchk = "";
                                apchk = kioskcntrl.UpdateAppointmentStatus(kioskview);
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show("There is problem with your details please contact reception counter");
    ...
    public void printappointmentreg()
    {
        status = 1;
        bool firstval;
        DataTable dtbl = new DataTable();
        ...
        try
        {
           ...
           // if (co == 0)
                    ...
                    if (firstval == true)
                    {
                        ...
                        if (dtbl.Rows.Count > 0)
                        {
                            foreach (DataRow dr in dtbl.Rows)
                            {
                                ...
                                string apchk1 = "";
                                apchk1 = kioskcntrl.UpdateAppointmentStatus(kioskview);
                                ////ensure the below three lines are needed
                                // kisokview.CustomerFullName = txt_customername.Text;
                                //kisokview.PatientId = Convert.ToInt32(rbl_memberlist.SelectedValue);
                                ////  Printer.Show(txt_esicno.Text, kisokview.QueueNummber);
                                ...
                                if (dtblvisit.Rows.Count > 0)
                                {
                                    foreach (DataRow dr1 in dtblvisit.Rows)
                                    {
                                        ...
                                        int selectedItem12 = Convert.ToInt16(dt1.Rows[0][0].ToString());
                                        kioskview.DepartmentId = selectedItem12;
                                        kioskview.OrderId = 1;
                                        kioskview.SmsStatusFlag = "N";
                                        insertsuccess = kioskcntrl.AddCustomerQueueTransactions(kioskview);
                                        if (insertsuccess == "1")
            ...
            else
            {
                ...
                string url = string.Format("kioskReprint.aspx?1={0}", Server.UrlEncode(queno));
                Response.Redirect(url, false);
                //string fname = Server.UrlDecode(Request.QueryString["1"]);
                //string lname = Server.UrlDecode(Request.QueryString["2"]);
                //string uname = Request.QueryString["3"];
    ...
    public void print()
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count == 0)
            {
                kioskview.ESCInNumber = "9999999999";
                //kioskview.CustomerFullName = dt.Rows[0][1].ToString();
                kioskview.PatientId = Convert.ToInt32(14258);
               ...
               // if (co == 0)
                {
                    ...
                    if (firstval == true)
                    {
                        ...
                        int selectedItem1 = Convert.ToInt32(dept);
                        dtbl = kioskcntrl.GetParticularDepartmentDetail(selectedItem1);
                        if (dtbl.Rows.Count > 0)
                        {
                            foreach (DataRow dr in dtbl.Rows)
                            {
                               ...
                               // kioskview.QueueNummberShow = queueno1.ToString();
                                ...
                                showqueueno = Convert.ToInt32(showqueueno1.Rows[0][0]);
                                string queueno2;
                                queueno2 = Server.UrlDecode(Request.QueryString["2"]);
                                showqueueno = showqueueno + Convert.ToInt32(queueno2);
                                showqueueno += 1;
                                //original
                               // kioskview.QueueNummberShow = showqueueno.ToString();
                               // updatesuccess = kioskcntrl.UpdateDeptQueuNo(selectedItem1, showqueueno);
...
//Please use kiosk reprint page here
                    string url = string.Format("kioskReprint.aspx?1={0}", Server.UrlEncode(queno));
                    Response.Redirect(url, false);
                  //  Response.Redirect("kioskReprint.aspx");
