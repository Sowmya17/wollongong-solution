            ...
            if (dt.Rows.Count != 0)
            {
                ...
                if (TotalQueue1 != 0)
                {
                    for (int i = 1; i <= TotalQueue1; i++)
                    {
                        ...
                        {
                            //lbl_dpt1room2.Content = dt.Rows[1][1].ToString();
                            //Label1.Text = dt.Rows[4][0].ToString();

                        }
                        if (i == 6)
                        {
                            //lbl_dpt1room2.Content = dt.Rows[1][1].ToString();
                           // Label2.Text = dt.Rows[5][0].ToString();

                        }
                        if (i == 7)
                        {
                            //lbl_dpt1room2.Content = dt.Rows[1][1].ToString();
                           // Label3.Text = dt.Rows[6][0].ToString();

                        }
                        if (i == 8)
                        {
                            //lbl_dpt1room2.Content = dt.Rows[1][1].ToString();
                           // Label4.Text = dt.Rows[7][0].ToString();
