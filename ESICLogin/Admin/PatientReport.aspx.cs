...
public partial class Admin_PatientReport : System.Web.UI.Page
{
    ...
    protected void btn_report_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string date1 = startdate.ToString("dd/MM/yyyy");
            string dept = "";
            ...
            ReportViewer1.ServerReport.ReportServerUrl = new Uri("http://192.168.0.16:8056/Reportserver");
            ReportViewer1.ServerReport.ReportPath = "/Patient Report/Report1";
            ReportParameter[] @parameters = new ReportParameter[1];
            @parameters[0] = new ReportParameter("date1", date1, true);
            @parameters[1] = new ReportParameter("dept", dept, true);
            ...
            IReportServerCredentials irsc = new CustomReportCredentials("ATTINDIA3-PC", "prashan261989", "ATTINDIA3-PC");
