<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientReport.aspx.cs" Inherits="Admin_PatientReport" %>
                    ...
                    <table align="center" style="width: 70%;
                        ...
                        <tr>
                            <td colspan="5" class="style5" align="center">
                                ...
                                <li><a href="PatientReport.aspx" style="text-decoration: none">Patient</a></li>
            <%--<li><a href="#">Reports</a>
            <div class="sub_menu">
        		<ul>
