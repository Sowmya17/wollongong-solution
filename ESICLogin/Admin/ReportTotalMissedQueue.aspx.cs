...
public partial class Admin_ReportTotalMissedQueue : System.Web.UI.Page
{
    ...
    protected void btn_report_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ReportViewer1.ServerReport.ReportServerUrl = new Uri("http://10.39.121.37:80/ReportServer");
            ReportViewer1.ServerReport.ReportPath = "/Waiting Time Report/WaitingTime";
            
            ReportParameter[] @parameters = new ReportParameter[2];
            @parameters[0] = new ReportParameter("FromDate", FromDate, true);
...
//        try
//        {
//            if (RadDatePicker1.SelectedDate != null && RadDatePicker1.SelectedDate.GetValueOrDefault() != DateTime.MinValue || RadDatePicker2.SelectedDate != null && RadDatePicker2.SelectedDate.GetValueOrDefault() != DateTime.MinValue)
//            {
...
//                string edate = endate.ToString("yyyy-MM-dd");
//                string status = "";
//                masterbel.DeviceUpdatedDateTime = Convert.ToDateTime(date);
//                masterbel.DeviceUpdatedDateTimeTo = Convert.ToDateTime(endate);
//                MyDepartmentGridViewBind = masterbal.ReportTotalGridViewLoading(masterbel);

//                MyDepartmentGridViewBind.Columns.Add("Doctor");
//                MyDepartmentGridViewBind.Columns.Add("ServiceStart");
//                MyDepartmentGridViewBind.Columns.Add("ServiceEnd");
//                MyDepartmentGridViewBind.Columns.Add("WaitingTime");
//                MyDepartmentGridViewBind.Columns.Add("ServingTime");

//                MyDepartmentGridViewBind.Columns.Add("Doctor1");

//                MyDepartmentGridViewBind.Columns.Add("ServiceStart1");
//                MyDepartmentGridViewBind.Columns.Add("ServiceEnd1");
//                MyDepartmentGridViewBind.Columns.Add("WaitingTime1");
//                MyDepartmentGridViewBind.Columns.Add("ServingTime1");
//                //}

//                //   gv_departmentmaster.AutoGenerateColumns = false;
//                foreach (DataRow queuestatus in MyDepartmentGridViewBind.Rows)
//                {
//                    masterbel.TransferID1 = Convert.ToInt16(queuestatus["visit_tnx_id"].ToString());
//                    status = queuestatus["consulting_status"].ToString();
//                    if (status == "A")
//                    {

//                        DtblNurse = masterbal.ReportNurseAppointment(masterbel);
//                        DtblDoctor = masterbal.ReportDoctorApp(masterbel);
//                    }
//                    else
//                    {
//                        DtblNurse = masterbal.ReportNurse(masterbel);
//                        DtblDoctor = masterbal.ReportDoctor(masterbel);
//                    }
//                    if (DtblNurse.Rows.Count > 0)
//                    {

//                        queuestatus["Doctor"] = DtblNurse.Rows[0][0].ToString();
//                        queuestatus["ServiceStart"] = DtblNurse.Rows[0][1].ToString();
//                        queuestatus["ServiceEnd"] = DtblNurse.Rows[0][2].ToString();
//                        queuestatus["WaitingTime"] = DtblNurse.Rows[0][3].ToString();
//                        queuestatus["ServingTime"] = DtblNurse.Rows[0][4].ToString();
//                    }
//                    if (DtblDoctor.Rows.Count > 0)
//                    {
//                        queuestatus["Doctor1"] = DtblDoctor.Rows[0][0].ToString();
//                        queuestatus["ServiceStart1"] = DtblDoctor.Rows[0][1].ToString();
//                        queuestatus["ServiceEnd1"] = DtblDoctor.Rows[0][2].ToString();
//                        queuestatus["WaitingTime1"] = DtblDoctor.Rows[0][3].ToString();
//                        queuestatus["ServingTime1"] = DtblDoctor.Rows[0][4].ToString();
//                    }
//                }
//                MyDepartmentGridViewBind.Columns.Remove("visit_tnx_id");
//                MyDepartmentGridViewBind.Columns.Remove("consulting_status");
...
//            MyDepartmentGridViewBind.Columns.Add("ConsultingType");
...
//                    //{
//                        if (queuestatus["consulting_status"].ToString() == "A")
//                        {
//                            queuestatus["ConsultingType"] = "APPOINTMENT";
//                            //ddl_patgender.SelectedIndex = 1;
//                        }
//                        //else if (queuestatus["consulting_status"].ToString() == "V")
//                        //{
//                        //    queuestatus["QueueToken"] = "VIP";
...
//                else
//                {
//                    if (queuestatus["consulting_status"].ToString() == "V")
//                    {
//                        queuestatus["ConsultingType"] = "VIP";
//                        // ddl_patgender.SelectedIndex = 2;
//                    }
//                    else if (queuestatus["consulting_status"].ToString() == "W")
//                    {
//                        queuestatus["ConsultingType"] = "WALK-IN";
//                    }
