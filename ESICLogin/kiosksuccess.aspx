<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kiosksuccess.aspx.cs" Inherits="kioskhome" %>
  ...
  <table style="margin-top:200px; margin-left:300px; " 
       ...
       <table style="margin-top:70px; margin-left:70px;" 
        align="center">
                <tr>
                <td>
                <asp:Label ID="Label1" runat="server" Text="Please remain in the waiting room until your number has been called." Font-Bold="True" ForeColor="Brown"
