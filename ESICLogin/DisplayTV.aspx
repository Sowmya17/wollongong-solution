<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DisplayTV.aspx.cs" Inherits="DisplayTV" %>
...
<body style=" background-image:url(images/bgnew13.png);  background-repeat:no-repeat; overflow:hidden; font-family:Calibri;" onload="startTime()">

    <form id="form1" runat="server">
    <iframe width="769" height="713" src="https://www.youtube.com/embed/5yAc2e955Tc?autoplay=1" frameborder="0" allowfullscreen></iframe>
    ...
    <table style="width:580px; height:460px; margin-top: -550px; margin-left: 636px;" cellpadding="0" 
            cellspacing="0">
  ...
  <%-- <tr style="width:1300px; height:53.5px;" >
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server" style="width: 180px; margin-left:170px;">
        <ContentTemplate>
            ...
            <td  style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style6">
        <asp:UpdatePanel ID="UpdatePanel46" runat="server" style="width: 180px; margin-left:80px;">
            <ContentTemplate>
    ...
    <td  style="text-align:center; font-size:45pt; font-weight:bolder;">
    <asp:UpdatePanel ID="UpdatePanel11" runat="server" style="width: 180px; margin-left: 170px;">
        <ContentTemplate>
            ...
            <td  style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style6">
        <asp:UpdatePanel ID="UpdatePanel48" runat="server" style="width: 180px; margin-left: 80px;">
            <ContentTemplate>
    ...
    <td  style="text-align:center; font-size:45pt; font-weight:bolder;">
    <asp:UpdatePanel ID="UpdatePanel14" runat="server" style=" width: 180px; margin-left: 170px;">
        <ContentTemplate>
        ...
        <td  style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style6">
        <asp:UpdatePanel ID="UpdatePanel50" runat="server" style=" width: 180px; margin-left: 80px;">
            <ContentTemplate>
    ...
    <td  style="text-align:center; font-size:45pt; font-weight:bolder;">
    <asp:UpdatePanel ID="UpdatePanel17" runat="server" style=" width: 180px; margin-left: 170px;">
        <ContentTemplate>
        ...
        <td  style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style6">
        <asp:UpdatePanel ID="UpdatePanel52" runat="server" style=" width: 180px; margin-left: 80px;">
            <ContentTemplate>
    ...
    <td  style="text-align:center; font-size:45pt; font-weight:bolder;">
    <asp:UpdatePanel ID="UpdatePanel20" runat="server" style=" width: 180px; margin-left: 170px;">
        <ContentTemplate>
        ...
        <td  style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style6">
        <asp:UpdatePanel ID="UpdatePanel54" runat="server" style=" width: 180px; margin-left: 80px" >
            <ContentTemplate>
   ...
   <%-- <table style="width:1397px; height:71px; border-top-style: none; border-top-color: inherit; border-top-width: 0px;"  
    ...
    <div style=" height:285px; margin-top:375px;">
    <table style="border-top-style: none; border-top-color: inherit; border-top-width: 0px; margin-top: -320px;"  
            cellpadding="0" cellspacing="0" class="style12">
    <tr style="width:100%;">
    
    <td style="text-align:center; font-size:45pt; font-weight:bolder;" class="style5">
    <asp:UpdatePanel ID="UpdatePanel98" runat="server" style="margin-top:100px; margin-left:90px;">
        <ContentTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanel99" runat="server" style="margin-top:100px; margin-left:230px;">
        <ContentTemplate>
        ...
        <td style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style8">
    <asp:UpdatePanel ID="UpdatePanel100" runat="server" style="margin-top:100px; margin-left:250px;">
        <ContentTemplate>
        ...
        <td style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style8">
    <asp:UpdatePanel ID="UpdatePanel101" runat="server" style="margin-top:100px; margin-left:220px;">
        <ContentTemplate>
    ...
    <table>
     ...
     <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="margin-top:100px;">
        <ContentTemplate>
        <asp:Label ID="Label1" ForeColor="White" runat="server" ></asp:Label>
           </ContentTemplate>
        </asp:UpdatePanel>
     ...
     <asp:UpdatePanel ID="UpdatePanel3" runat="server" >
        <ContentTemplate>
        <asp:Label ID="Label2" ForeColor="White" runat="server" ></asp:Label>
           </ContentTemplate>
        </asp:UpdatePanel>
     ...
     <asp:UpdatePanel ID="UpdatePanel6" runat="server" style="margin-top:0px;">
        <ContentTemplate>
     ...
     <asp:UpdatePanel ID="UpdatePanel4" runat="server" style="margin-top:0px;">
        <ContentTemplate>
        <asp:Label ID="Label3" ForeColor="White" runat="server" ></asp:Label>
           </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <asp:UpdatePanel ID="UpdatePanel5" runat="server" style="margin-top:0px;">
        <ContentTemplate>
...
<%--
<table style="width:321px; height:158px; border-top-style: none; border-top-color: inherit; border-top-width: 0px; margin-top: -10px; margin-left: 325px;"  
            cellpadding="0" cellspacing="0">
    <tr style="width:100%;">
    
    <td style="text-align:center; font-size:45pt; font-weight:bolder;" class="style5">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="margin-top:100px; margin-left:-30px;">
        <ContentTemplate>
        <asp:Label ID="Label1" ForeColor="White" runat="server" ></asp:Label>
           </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <asp:UpdatePanel ID="UpdatePanel4" runat="server" style="margin-top:30px;">
        ...
        <td style="text-align:center; font-size:45pt; font-weight:bolder;" 
            class="style8">
    <asp:UpdatePanel ID="UpdatePanel5" runat="server" style="margin-top:30px;">
        <ContentTemplate>
        <asp:Label ID="Label4" ForeColor="White" runat="server" ></asp:Label>
           </ContentTemplate>
        </asp:UpdatePanel> 
    ...
    <tr>
    <td class="style11">
    <div  style="width:1080px; height: 41px; background: black none repeat scroll 0% 0%; margin: -90px 0px 0px 4px; border-right-style: solid; border-bottom-width: 0px; border-bottom-style: solid; padding-bottom: 0px; border-left-width: 0px; border-left-style: solid; padding-left: 0px; padding-right: 1px; border-right-width: 0px;">

    <marquee style="margin-left: 0px; font-size: 35px; color: White; width: 1080px; height: 52px;" 
            loop="true" direction="left">
   <%-- <html:div style="display: -moz-box; overflow: hidden; width: -moz-available; margin-right: -324px;">
    ...
    <div style="height: 72px; width: 308px; margin-left:-50px; margin-top: -115px;">
